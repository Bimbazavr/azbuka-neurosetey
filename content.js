...
window.AZBUKA = {
  ...
  workshopsAll: [
    ...
    { id: 5, title: 'Промт-инжиниринг: продвинутый', emoji: '⚙️', tag: 'Технологии', level: 'Продвинутый', format: 'Онлайн', price: 3500, seats: 5, date: '24 мая', teacher: 'Катя', duration: '3 ч', desc: 'Углублённый воркшоп по написанию промтов для сложных задач. Агенты, цепочки, автоматизация.' },
